          ...
          if isempty(newval) 
              ...
              elseif h(6)==4    % quantize to value in h(quant)
                 newval=h(7)*round(newval/h(7));  
                  ...
                  disp([num2str(h(6)),': unsupported mode in slider.mi']);
              end;
