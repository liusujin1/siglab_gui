...
class AnalysisViewerUiTests(unittest.TestCase):
    ...
    def test_standalone_conversion_viewer_uses_conversion_only_layout(self):
        ...
        try:
            ...
            self.assertIsNotNone(viewer.derived_curve_dialog)
            ...
            self.assertFalse(hasattr(viewer, "derived_settings_tabs"))
            ...
            self.assertFalse(viewer.derived_parameter_dialog.isVisible())
            viewer._show_derived_parameter_dialog()
            self.assertTrue(viewer.derived_parameter_dialog.isVisible())
            viewer.derived_parameter_dialog.hide()
            self.assertFalse(viewer.derived_curve_dialog.isVisible())
            viewer._show_derived_curve_dialog()
            self.assertTrue(viewer.derived_curve_dialog.isVisible())
            viewer.derived_curve_dialog.hide()
            self.assertFalse(viewer.derived_processing_dialog.isVisible())
            viewer._show_derived_processing_dialog()
            self.assertTrue(viewer.derived_processing_dialog.isVisible())
            viewer.derived_processing_dialog.hide()
