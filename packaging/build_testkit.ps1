...
# so tests and PyInstaller analysis prove the beta.6 runtime is independent.
...
Run $python @('-c',
    "import importlib.util; assert importlib.util.find_spec('scipy') is None, 'SciPy residue remains in beta.10 build environment'")
