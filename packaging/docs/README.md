...
Python/Qt/NumPy runtime. The beta.8 runtime keeps beta.4's Qt/OpenGL trimming,
derives its window, font and shell density from the Qt logical work area,
