...
class VibrationAnalysisPage(DiagnosticPage):
    ...
    def _build_ui(self) -> None:
        ...
        self.controls_column.setMaximumWidth(520)
        ...
        self.main_splitter.setObjectName("vibrationMainSplitter")
        self.main_splitter.setChildrenCollapsible(False)
        self.main_splitter.addWidget(self.controls_column)
        self.main_splitter.addWidget(self.tabs)
        self.main_splitter.setStretchFactor(0, 0)
        self.main_splitter.setStretchFactor(1, 1)
        self.main_splitter.setSizes([310, 900])
...
class TraceAnalysisPage(DiagnosticPage):
    ...
    def _build_ui(self) -> None:
        ...
        self.main_splitter = QtWidgets.QSplitter(QtCore.Qt.Horizontal)
        self.main_splitter.setObjectName("traceMainSplitter")
        self.main_splitter.setChildrenCollapsible(False)
        self.main_splitter.addWidget(self.controls_column)
        self.main_splitter.addWidget(self.tabs)
        self.main_splitter.setStretchFactor(0, 0)
